...
/**
 * View actions for interacting with {@link BottomNavigationView}
 */
public final class BottomNavigationViewActions {

    private BottomNavigationViewActions() {
        // no Instance
    }

    /**
     * Returns a {@link ViewAction} that navigates to a menu item in {@link BottomNavigationView} using a
     ...
     * <ul>
     *
     * <li>View must be of type {@link BottomNavigationView}
    ...
    public static ViewAction navigateTo(final int menuItemId) {
        ...
        return new ViewAction() {
            ...
            public Matcher<View> getConstraints() {
                return allOf(
                        isAssignableFrom(BottomNavigationView.class),
